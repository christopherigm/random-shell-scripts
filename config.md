...
### Python & VirtualEnvs
```
$ sudo apt install libpq-dev python-dev python3-dev build-essential python-setuptools postgresql-server-dev-all python-psyc opg2 install python3-distutils
```
...
$ sudo apt update && sudo apt -y upgrade && sudo apt install postgis
```
